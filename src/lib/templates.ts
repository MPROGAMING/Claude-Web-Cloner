...
export interface Template {
  ...
  imageAlt: string;
  /**
   * Real sourced artwork for this genre.
   *
   * Glyph art is honest decoration but it does not tell a creator what the
   * genre looks like. These are real images, sourced rather than built — a
   * scene constructed by hand purely to fill a banner is a picture of nothing
   * anyone will ever play, and costs far more than it communicates.
   */
  banner?: { src: string; alt: string; focal?: string; credit?: string };
...
export const TEMPLATES: Template[] = [
  {
    ...
    category: "Simulator",
    banner: {
      src: "/templates/simulator.jpg",
      alt: "Isometric cartoon supermarket with checkouts, stocked shelves and a shopper with a trolley",
  ...
  },
  {
    ...
    category: "Obby",
    banner: {
      src: "/templates/obby.jpg",
      alt: "Isometric cartoon obstacle course of floating grass and snow islands linked by plank bridges, with jump pads and coins",
      credit: "Kenney (kenney.nl), CC0",
    },
    icon: "flag",
    art: "GiJumpAcross",
  ...
  },
  {
    ...
    category: "Tycoon",
    banner: {
      src: "/templates/tycoon.jpg",
      alt: "Isometric cartoon factory floor with conveyor belts, hoppers and robot arms",
      credit: "Kenney (kenney.nl), CC0",
    },
    icon: "factory",
    art: "GiFactory",
  ...
  },
  {
    ...
    category: "Horror",
    banner: {
      src: "/templates/horror.jpg",
      alt: "Isometric cartoon graveyard with a crypt, iron railings, gravestones and a skeleton",
      credit: "Kenney (kenney.nl), CC0",
    },
    icon: "ghost",
    art: "GiGhost",
  ...
  },
  {
    ...
    category: "Survival",
    banner: {
      src: "/templates/survival.jpg",
      alt: "Isometric cartoon wilderness camp with a lookout tower, lean-to shelters, a crafting bench and a campfire",
      credit: "Kenney (kenney.nl), CC0",
    },
    icon: "tent",
    art: "GiCampfire",
  ...
  },
  {
    ...
    category: "PvP",
    banner: {
      src: "/templates/pvp.jpg",
      alt: "Isometric cartoon stone arena with stepped seating, a trophy and armed fighters",
      credit: "Kenney (kenney.nl), CC0",
    },
    icon: "swords",
    art: "GiCrossedSwords",
  ...
  },
  {
    ...
    banner: {
      src: "/templates/tower-defense.jpg",
      alt: "Isometric cartoon map with turrets planted along a winding path across modular tiles",
      credit: "Kenney (kenney.nl), CC0",
    },
    icon: "castle",
    art: "GiTowerFlag",
  ...
  },
  {
    ...
    category: "RPG",
    banner: {
      src: "/templates/rpg.jpg",
      alt: "Isometric cartoon fantasy village with a windmill, watermill, great hall and market stalls",
      credit: "Kenney (kenney.nl), CC0",
    },
    icon: "scroll",
  ...
  },
  {
    ...
    category: "Racing",
    banner: {
      src: "/templates/racing.jpg",
      alt: "Isometric cartoon race circuit with kerbs, a pit building, grandstands and cars on track",
      credit: "Kenney (kenney.nl), CC0",
    },
  ...
  },
  {
    ...
    category: "Social",
    banner: {
      src: "/templates/social.jpg",
      alt: "Isometric cartoon arcade full of cabinets and racing seats with people playing them",
      credit: "Kenney (kenney.nl), CC0",
    },
    icon: "users",
    art: "GiThreeFriends",
  ...
  },
  {
    ...
    category: "Story",
    banner: {
      src: "/templates/story.jpg",
      alt: "Isometric cartoon pirate island with a fort, a watchtower, a wreck and a ghost-sailed ship",
      credit: "Kenney (kenney.nl), CC0",
    },
    icon: "book-open",
    art: "GiOpenBook",
  ...
  },
  {
    ...
    category: "Strategy",
    banner: {
      src: "/templates/strategy.jpg",
      alt: "Isometric cartoon hex-tile map with castles, villages, roads and rivers",
      credit: "Kenney (kenney.nl), CC0",
    },
    icon: "grid-3x3",
    art: "GiChessRook",
