          ...
          >
            <span className="relative block h-24 overflow-hidden">
              ...
              <span
                ...
                style={{
                  // Mixed toward the page ink rather than used raw. The accents
                  // are chosen to look right as a gradient, and the darkest of
                  // them (horror, oklch 0.5) reads 3.0:1 as 9px text. Mixing
                  // keeps each template's hue and lets the theme supply the
                  // lightness the label needs.
